...
export default function Card({card}) {
    const {name, description, image_url, price, live, priceCurrency} = card;
    return (
        <>
        ...
        <div className='h-[300px] w-[300px] rounded-xl mb-4 bg-airstay-red relative overflow-hidden'>
            <img className='absolute object-cover w-full h-full' src={image_url} alt={name} />
        ...
        <p> {priceCurrency}{price} per person </p>
        </Link>
